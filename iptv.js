...
function playChannel(index) {
  ...
  // Trigger reconnect if stream fails
  video.onerror = startReconnectLoop;
  video.onstalled = startReconnectLoop;
  video.onwaiting = startReconnectLoop;

  // Stop reconnect loop when playback is successful
