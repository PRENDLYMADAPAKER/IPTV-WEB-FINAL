...
let lastTime = 0;
let freezeCheckInterval = setInterval(() => {
  if (video.paused || video.readyState < 2) return;
  if (video.currentTime === lastTime) {
    console.warn("Freeze detected, attempting reconnect...");
    reconnectStream();
  } else {
...
// Overlay UI for reconnecting
const overlay = document.createElement("div");
overlay.innerHTML = "<span style='font-size:20px;'>Reconnecting…</span>";
